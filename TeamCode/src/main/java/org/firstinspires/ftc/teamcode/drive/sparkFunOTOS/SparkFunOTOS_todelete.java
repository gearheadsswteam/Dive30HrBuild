...
/**
 * {@link SparkFunOTOS_todelete} is the Java driver for the SparkFun Qwiic Optical Tracking Odometry Sensor
...
public class SparkFunOTOS_todelete extends I2cDeviceSynchDevice<I2cDeviceSynch> {
    ...
    public SparkFunOTOS_todelete(I2cDeviceSynch deviceClient)
    {
